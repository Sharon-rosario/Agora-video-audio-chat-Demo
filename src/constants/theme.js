...
export const COLORS = {
  ...
  /* chat surfaces */
  sent: '#28328C',            // Updated: Dark blue for sent messages
  received: '#2596FF',        // Updated: Lighter blue for received messages
  bubbleBg: '#F3F4F6',        // Light grayish background for the container
  chatBg: '#FFFFFF',          // Updated: White background for the chat panel
...
/* --------  4 •  CHAT-MODULE THEME  -------------------------------------- */
export const ChatTheme = {
  bubbleMe: COLORS.sent,      // Updated: Now uses #28328C (dark blue)
  bubbleOthers: COLORS.received, // Updated: Now uses #2596FF (lighter blue)
  ...
  textPrimary: '#1E293B',
  timeStamp: '#64748B',
  chatBg: COLORS.chatBg,     // Updated: Now uses #FFFFFF (white)
  ...
  // Update panelBg and footerBg to match the new chat panel background
  panelBg: COLORS.chatBg,    // Updated: Now uses #FFFFFF (white)
  footerBg: COLORS.chatBg,   // Updated: Now uses #FFFFFF (white)

  // Adjust text colors for better contrast on the new message backgrounds
  textPrimary: '#FFFFFF',    // Updated: White text for better contrast on dark blue backgrounds
  textSecondary: '#D1D5DB',  // Updated: Light gray for secondary text (e.g., timestamps) on dark backgrounds
  timeStamp: '#D1D5DB',      // Updated: Light gray for timestamps on dark backgrounds
};
...
export const ConsultationTheme = {
  pageBg:           COLORS.chatBg, // Updated: Now uses #FFFFFF (white)
...
export const callRequestMessageTheme = {
  ...
  background: COLORS.chatBg, // Updated: Now uses #FFFFFF (white) to match chat panel
...
/* --------  8 •  CALL REQUEST STYLES  ------------------------------------ */
export const CallRequestStyles = {
  container: {
    backgroundColor: ChatTheme.panelBg, // Updated: Now uses #FFFFFF (white)
    borderColor: ConsultationTheme.dividerBg,
    borderTopColor: ChatTheme.videoPlayBtnFg,
  },
  icon: {
    color: ChatTheme.videoPlayBtnFg,
  },
  title: {
    color: ChatTheme.textPrimary, // Updated: Now uses #FFFFFF (white) for consistency
  },
  info: {
    color: ChatTheme.textSecondary, // Updated: Now uses #D1D5DB (light gray)
  },
  acceptButton: {
    backgroundColor: ChatTheme.success,
    color: ChatTheme.light,
  ...
  timestamp: {
    color: ChatTheme.timeStamp, // Updated: Now uses #D1D5DB (light gray)
  },
  menuButton: {
    color: ChatTheme.textSecondary, // Updated: Now uses #D1D5DB (light gray)
    hoverColor: '#333333',
  ...
  menuItem: {
    reply: {
      color: '#28328C', // Updated: Now uses #FFFFFF (white)
      hoverBackground: ChatTheme.hoverNeutral,
    },
    delete: {
      color: '#28328C',
